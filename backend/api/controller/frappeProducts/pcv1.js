...
exports.getPCV1Data = ({
  ...
  const R56 = (quantity * 14 * P45) / 1000;
  const R57 = (quantity * 4 * 600) / 1000;
  const R58 = (quantity * 2 * (P52 - 1420)) / 1000;
  const R59 = (quantity * 4 * 240) / 1000;
  const R60 = (quantity * 2 * (P52 - 700)) / 1000;
  const R61 = (quantity * 2 * (P52 - 140)) / 1000;
