...
exports.getPOB1Data = ({
  ...
  const S50 = (R52 + R53) * 1.07;

  const R56 = (quantity * 4 * (P51 - 140)) / 1000;
  const R57 = (quantity * 2 * H51) / 1000;
  const R58 = (quantity * 2 * (P52 - 180 - H51)) / 1000;
    ...
    glazzingValues: [
      {
        ...
        height: [9, 10]?.includes(glazzingVal) ? 0 : P52 - 185 - H51,
      },
    ],
  };
};
