...
exports.getPOBE1Data = ({
  ...
  const R52 = (quantity * 4 * P51) / 1000;
  const R53 = (quantity * 2 * P52) / 1000;
  const R54 = (quantity * 2 * P53) / 1000;
  const S50 = (R52 + R53 + R54) * 1.07;

  const R56 = (quantity * 4 * (P51 - 140)) / 1000;
  const R57 = (quantity * 2 * P52 - 140) / 1000;
  const R58 = (quantity * 2 * (P53 - 140)) / 1000;
  ...
  return {
    profiles: [
...

      {
        ...
        color: color,
        param: "Heith",
        quantity: (Math.ceil((P51 - 180) / 140) - 1) * quantity,
        length: P53 - 120,
      },
    ...
    accessories: [
      ...
      },
      {
        ...
        color: "",
        quantity: (Math.ceil((P51 - 180) / 140) - 1) * quantity * 2,
      },
    ...
    glazzingValues: [
      {
        ...
        height: [9, 10]?.includes(glazzingVal) ? 0 : P53 - 145,
      },
    ],
  };
};
