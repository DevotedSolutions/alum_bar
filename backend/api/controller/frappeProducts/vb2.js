  ...
  return {
    ...
    accessories: [
      ...
      },
      {
        ...
        color,
        quantity: (thirdPartyValue === 775 ? 0 : 2) * quantity,
      },
      {
        name: accessories[13]?.name,
        code: accessories[13]?.code,
        color,
        quantity: (thirdPartyValue === 775 ? 2 : 0) * quantity,
      },
      ...
      },
      {
        ...
        color: "",
        quantity: thirdPartyValue === 775 ? 0 : Math.round(S50),
      },
    ],
    glazzingValues: [
      {
        ...
        width: [9, 10]?.includes(glazzingVal) ? 0 : P50 - 126,
